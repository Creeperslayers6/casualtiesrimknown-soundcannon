...
namespace CasualtiesRimknown_SoundCannon
{
    public class CasualtiesRimknownSoundCannon_Mod : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            settings.shockwaveNormalVolumeCoef = ListA.SliderLabeled("CRSC_Setting_ShockwaveNormalVolume".Translate(settings.shockwaveNormalVolumeCoef.ToString("D2"), settings.shockwaveNormalVolumeCoef, 0f, 5f, 0.5f, "CRSC_Setting_ShockwaveNormalVolume_TT".Translate());
            settings.shockwaveLoudVolumeCoef = ListA.SliderLabeled("CRSC_Setting_ShockwaveLoudVolume".Translate(settings.shockwaveLoudVolumeCoef.ToString("D2")), settings.shockwaveLoudVolumeCoef, 0f, 5f, 0.5f, "CRSC_Setting_ShockwaveLoudVolume_TT".Translate());
            ListA.End();
            //
